...
namespace VAU.FlightMenuSystem.Integration.UrcRedux.Runtime
{
    ...
    public sealed class FlightMenuRadioController : UdonSharpBehaviour
    {
        ...
        private void Start()
        {
            ...
            var newArray = new UdonSharpBehaviour[transceiver.CallbackBehaviours.Length + 1];
            transceiver.CallbackBehaviours.CopyTo(newArray, 0);
            newArray[transceiver.CallbackBehaviours.Length] = this;
